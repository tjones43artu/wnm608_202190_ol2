...
<body>
  ...
  <div class="container">
  	<div>
  		<h2>Product Lists</h2>
      <div class="view-window" style="background-image:url(img/junel-mujar-51jzoz1dsro-unsplash.jpg);"><h1 style="text-align: center; color: white; margin-top: 120px;">Products</h1>
</div>
